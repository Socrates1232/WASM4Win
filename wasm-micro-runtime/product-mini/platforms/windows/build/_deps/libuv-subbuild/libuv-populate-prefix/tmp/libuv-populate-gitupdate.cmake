...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "v1.39.0"
  WORKING_DIRECTORY "D:/wasm/wasm-micro-runtime/product-mini/platforms/windows/build/_deps/libuv-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.39.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.39.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/wasm/wasm-micro-runtime/product-mini/platforms/windows/build/_deps/libuv-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/wasm/wasm-micro-runtime/product-mini/platforms/windows/build/_deps/libuv-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
